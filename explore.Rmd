---
title: "A potential biological correlate of _design intent_ for Gary dart points from the American Southeast: A case study from the Poverty Point World Heritage Site"
...
```{r outlines + attributes, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE}
# generate outlines
outlines <- jpg.list %>%
  import_jpg()

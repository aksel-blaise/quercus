...
\title{A potential biological correlate of design intent for Gary dart
points from the American Southeast}
...
humanities; mental model; \emph{Quercus nigra}
\end{keywords}

\hypertarget{introduction}{%
\section{Introduction}\label{introduction}}

The majority of dart point types recovered from archaeological sites in
the American Southeast---to include Gary dart points---have been
identified on the basis of shape attributes \citep{RN5764,RN6840}; the
defining characteristic of a morphological type \citep{RN8233}.
...
scans of the Gary dart points from the Cooper, Means, Miller, Poverty
Point, and Yarbrough sites. Thanks to \ldots{} for their comments on the
analysis, and to Dean C. Adams, Michael L. Collyer, Emma Sherratt,
Lauren Butaric, and Kersten Bergstrom for their constructive criticisms,
